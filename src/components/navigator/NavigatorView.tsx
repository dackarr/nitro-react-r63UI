        ...
        <>
            { isVisible &&
                <NitroCardView uniqueKey="navigator" className={ `nitro-navigator ${ isOpenSavesSearchs ? 'expanded' : '' }` }>
                    <NitroCardHeaderView headerText={ LocalizeText('navigator.title') } isInfoToHabboPages={ true } onClickInfoHabboPages={ () => CreateLinkEvent('habbopages/navigator.html') } onCloseClick={ event => setIsVisible(false) } />
                    <NitroCardTabsView>
                        <Base className="mt-1">
