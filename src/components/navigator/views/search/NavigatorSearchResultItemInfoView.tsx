                            ...
                            <Column gap={ 1 }>
                                ...
                                <Flex gap={ 2 }>
                                    ...
                                    <Flex alignItems="center" gap={ 1 }>
                                        ...
                                        <Text onClick={ () => GetUserProfile(roomData.ownerId) } italics>{ roomData.ownerName }</Text>
                                    </Flex>
                                </Flex>
                        ...
                        <Column>
                            <Flex>
                                <Flex gap={ 1 } className="align-items-center">
                                    <UserProfileIconView onClick={ () => GetUserProfile(roomData.ownerId) } userId={ roomData.ownerId }/>
                                    <Text onClick={ () => GetUserProfile(roomData.ownerId) } pointer bold underline>{ roomData.ownerName }</Text>
                                </Flex>
