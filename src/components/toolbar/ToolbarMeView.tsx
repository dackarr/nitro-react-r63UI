...
export const ToolbarMeView: FC<PropsWithChildren<ToolbarMeViewProps>> = props =>
{
    ...
    return (
        <Flex column alignItems="center" className="nitro-toolbar-me p-2" gap={ 3 }>
            { GetConfiguration('guides.enabled') && (
                <Column
                    gap={ 1 }
                    alignItems="center"
            ...
            >
                <div className="navigation-item icon icon-me-achievements">
