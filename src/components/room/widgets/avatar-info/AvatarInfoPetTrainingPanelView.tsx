...
export const AvatarInfoPetTrainingPanelView: FC<{}> = props =>
{
    ...
    return (
        <NitroCardView uniqueKey="pet-training" className="pet-training-window no-resize" theme="primary">
            <NitroCardHeaderView headerText={ LocalizeText('widgets.pet.commands.title') } isInfoToHabboPages={ true } onClickInfoHabboPages={ () => CreateLinkEvent('habbopages/help/pets/training.html') } onCloseClick={ () => setPetTrainInformation(null) } />
