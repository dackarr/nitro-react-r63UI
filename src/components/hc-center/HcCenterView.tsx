...
export const HcCenterView: FC<{}> = props =>
{
    ...
    const popover = (
        <Popover id="popover-basic">
            <Popover.Body className="text-black py-2 px-3">
                ...
                <div className="btn btn-link text-primary p-0" onClick={ () => CreateLinkEvent('habbopages/' + GetConfiguration('hc.center')['payday.habbopage'] + '.html') }>
    ...
    return (
        <NitroCardView theme="primary" className="nitro-hc-center">
            <NitroCardHeaderView headerText={ LocalizeText('generic.hccenter') } isInfoToHabboPages={ true } onClickInfoHabboPages={ () => CreateLinkEvent('habbopages/' + GetConfiguration('hc.center')['benefits.habbopage'] + '.html') } onCloseClick={ () => setIsVisible(false) } />
            ...
            <NitroCardContentView>
                ...
                { GetConfiguration('hc.center')['payday.info'] &&
                    <Flex alignItems="center">
                        <Column gap={ 1 } className="p-2 payday-special mb-1 ml-1">
                            ...
                            <Text variant="white" small underline className="pt-4 cursor-pointer" onClick={ () => CreateLinkEvent('habbopages/' + GetConfiguration('hc.center')['payday.habbopage'] + '.html') }>{ LocalizeText('hccenter.special.infolink') }</Text>
                ...
                { GetConfiguration('hc.center')['benefits.info'] &&
                    <Column className="benefits py-2">
                        ...
                        <Text small underline className="cursor-pointer" variant="primary" onClick={ () => CreateLinkEvent('habbopages/' + GetConfiguration('hc.center')['benefits.habbopage'] + '.html') }>
